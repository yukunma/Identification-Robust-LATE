...
for (iter in 1 : NUM_RERANDOMIZATION) {
  ...
  for (kdx in 1:max(k)){
    ...
    Y_Xbeta22_all        =  rbind(Y_Xbeta22_all, Y_Xbeta22_temp);
    Y_beta21_Xbeta22_all =  rbind(Y_beta21_Xbeta22_all,Y_beta21_Xbeta22_temp) ;
    Xgamma_all           =  rbind(Xgamma_all, Xgamma_temp);
    beta11_Xbeta12_all   =  rbind(beta11_Xbeta12_all, beta11_Xbeta12_temp);
    Xbeta12_all          =  rbind(Xbeta12_all,Xbeta12_temp);
